package com.caiqueribeiro.admin.catalogo.domain.category;

import com.caiqueribeiro.admin.catalogo.domain.exceptions.DomainException;
import com.caiqueribeiro.admin.catalogo.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAValidCategory_whenCallUpdate_thenReturnCategoryUpdated() {
        ...
        final var expectedIsActive = true;
        final var aCategory =
                Category.newCategory("Film", "Uma categoria", expectedIsActive);
        Assertions.assertDoesNotThrow(() -> aCategory.validate(new ThrowsValidationHandler()));
    ...
    public void givenAValidCategory_whenCallUpdateToInactivate_thenReturnCategoryUpdated() {
        ...
        final var expectedIsActive = false;
        final var aCategory =
                Category.newCategory("Film", "Uma categoria", true);
        Assertions.assertDoesNotThrow(() -> aCategory.validate(new ThrowsValidationHandler()));
    ...
    public void givenAValidCategory_whenCallUpdateWithInvalidParams_thenReturnCategoryUpdated() {
        ...
        final var expectedIsActive = true;
        final var aCategory =
                Category.newCategory("Filmes", "Uma categoria", expectedIsActive);
        Assertions.assertDoesNotThrow(() -> aCategory.validate(new ThrowsValidationHandler()));
